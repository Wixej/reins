    ...
    return Column(
      ...
      children: [
        InkWell(
          ...
          child: Row(
            children: [
              Text('Ход мысли', style: TextStyle(color: _thoughtColor)),
              Icon(_thoughtButtonIcon, color: _thoughtColor),
            ],
          ),
        ),
        if (_showingThought) SelectableText(widget.content, style: TextStyle(color: _thoughtColor)),
      ],
    );
  }

  IconData get _thoughtButtonIcon => _showingThought ? Icons.keyboard_arrow_down : Icons.keyboard_arrow_up;
