...
ORDER BY last_update DESC;''');
  ...
  Future<List<ChatSearchResult>> searchMessages(String query, {int limit = 50}) async {
    final normalizedQuery = query.trim();
    if (normalizedQuery.isEmpty) return const [];

    final escapedQuery = normalizedQuery.replaceAll(r'\', r'\\').replaceAll('%', r'\%').replaceAll('_', r'\_');
...
''',
    ...
    return maps.map((map) {
      return ChatSearchResult(
        ...
        role: OllamaMessageRole.fromString(map['role'] as String),
