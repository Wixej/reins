...
class ImageService {
  ...
  static const int defaultMinImageWidth = 2048;
  static const int defaultMinImageHeight = 2048;
  ...
  Future<File?> compressAndSave(
    ...
    int minWidth = defaultMinImageWidth,
    int minHeight = defaultMinImageHeight,
  }) async {
    try {
  ...
  Future<File?> _compressAndSaveImageForPlatform(
    ...
    if (Platform.isLinux) {
      return _compressAndSaveImageLinux(
        sourcePath,
        targetPath,
        quality: quality,
      );
