...
void main() {
  ...
  final skipOllamaIntegrationTests = Platform.environment['RUN_OLLAMA_INTEGRATION_TESTS'] == 'true'
      ? false
      : 'Set RUN_OLLAMA_INTEGRATION_TESTS=true to run live Ollama endpoint tests.';
  ...
  }, skip: skipOllamaIntegrationTests);
  ...
  }, timeout: Timeout.none, skip: skipOllamaIntegrationTests);
  ...
  test("Test OllamaMessage parses thinking responses", () {
    final message = OllamaMessage.fromJson({
      "model": "qwen3",
      "created_at": "2026-04-04T10:00:00Z",
      "message": {"role": "assistant", "content": "", "thinking": "Let me think this through."},
      "done": false,
    });

    expect(message.content, isEmpty);
    expect(message.thinking, "Let me think this through.");
  });
}
